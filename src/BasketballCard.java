public class BasketballCard extends Card
{
    ...
    BasketballCard(int id, int cardSeriesId, String condition, String playerName, String club, int seasonsPlayed, int gamesPlayed, String sport, int fgPercent, int ftPercent, double averagePoints) {
    ...
    public double getAveragePoints() {return this.averagePoints;}

    @Override
    public String toString() {
        return
                "BasketballCard{" +"id=" + getId() +
